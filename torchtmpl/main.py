...
if __name__ == "__main__":
    ...
    parser.add_argument("command", choices=["train", "test", "test_proba", "sub", "sub_ensemble"], help="Command to execute")
    parser.add_argument("--tta", action="store_true", help="Enable Test-Time Augmentation (TTA)")  # Par défaut, False
